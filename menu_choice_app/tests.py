...
from menu_choice_app.serializers import RestaurantSerializer, MenuSerializer

RESTAURANTS_URL = reverse("menu_choice_app:restaurant-list")
MENU_URL = reverse("menu_choice_app:menu-list")
SELECTED_MENU_URL = reverse("menu_choice_app:menu-select-menu")
...
class SelectMenuSystemTest(TestCase):
